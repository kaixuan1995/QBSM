...
<html lang="en">
	...
	<head>
		<title>申请领用——BlueDot物资管理系统</title>
	...
	<body>
		...
		$("#first_office_id").change(
			...
			$("#addwuzhi").click(function(){
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/addshenqinglingyong",
			...
			$("#yes").click(function(){
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/tongguoshenqinglingyong",
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getshenqinglingyong";
			var tablename = "物资列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/saveshenqinglingyong";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['库存编号',  '物资名称','物资品牌','单位','规格','物资类别','货号','供应商','有效期','现有库存'];//,'最低库存','最高库存'
			var pagecolmodel =  [
