...
<html lang="en">
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="<%=basePath%>PurchaseManagaAction/suoyoucaigoushenqing">
										<i class="icon-double-angle-right"></i>
										所有申请
									</a>
								</li>
									...
									<div class="input-group">
										<span class="input-group-btn ">
											<select class="form-control width-auto " id="select">
												<option value="1">采购单凭证单</option>
												<option value="2">个人采购凭证单</option>												
											</select>
										</span>
									</div>
  ...
  font-family:宋体;color:#333333'>采购原因处按实际情况填写为：零库存需采购、已有库存但不足使用一周、科研制标用或备货等。</span></p>
		...
		<script type="text/javascript">
			...
			var pageurl ="<%=basePath%>"+"PurchaseManageAction/getdanjuchuli?type=1";
			var tablename = "单据列表";
