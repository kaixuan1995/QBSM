...
<html lang="en">
	<head>
		...
		<title>所有申请——BlueDot物资管理系统</title>
	...
	<body>
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="<%=basePath%>assets/CGY/shenqingtianjiawuzixinxi.jsp">
										<i class="icon-double-angle-right"></i>
										申请添加物资信息
									</a>
								</li>
		...
		<script type="text/javascript">
			...
			var pageurl ="<%=basePath%>"+"PurchaseManageAction/getsuoyoushenqing";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"PurchaseManageAction/savesuoyoushenqing";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['申请单号','申请科室','申请时间','是否加急','状态'];
			var pagecolmodel =  [
			...
			var pageurlo ="<%=basePath%>"+"PurchaseManageAction/getsuoyoushenqing2";
			var tablenameo = "详细列表";
