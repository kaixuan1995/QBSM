...
<html lang="en">
	...
	<body>
		...
		<script type="text/javascript">
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getsuoyoushenqing";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/savesuoyoushenqing";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['申请单号','申请人','申请时间','是否加急','状态'];
			var pagecolmodel =  [
