...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>申请退货——BlueDot物资管理系统</title>
	...
	<body>
		...
		$("#no").click(function aaa(){
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/getshenqingtuihuo2",
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getshenqingtuihuo";
			var tablename = "物资列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/saveshenqingtuihuo";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var pageediturlo ="<%=basePath%>"+"StoreManageAction/getrukuguanli2";
			//navButtons
			var editobtn=true;
			var addobtn=false;
			var delobtn=true;
