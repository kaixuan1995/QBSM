...
<html lang="en">
	<head>
		...
		<title>出库管理——BlueDot物资管理系统</title>
	...
	<body>
		...
		<script type="text/javascript">
			...
			$("#no").click(function aaa(){
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/getchukuguanli3",
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getchukuguanli";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/savechukuguanli";
			//navButtons
			var editbtn=true;
			var addbtn=false;
			var delbtn=false;
