...
<html lang="en">
	<head>
		...
		<title>我的仓库调度——BlueDot物资管理系统</title>
	...
	<body>
		...
		<script type="text/javascript">
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getdiaoduwode";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/savediaoduwode";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['申请单号', '类型','申请仓库','申请时间','是否加急','状态'];
			var pagecolmodel =  [
