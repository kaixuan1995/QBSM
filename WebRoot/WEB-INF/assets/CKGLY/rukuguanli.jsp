...
<html lang="en">
	<head>
		...
		<title>入库管理——BlueDot物资管理系统</title>
	...
	<body>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="modal-footer">
										<font color="red">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-select-4">请选择仓库分区：</label></font>
										<div class="col-sm-9">
											<select class="col-xs-9 col-sm-3" id="place" name="place_id" data-placeholder="请选择仓库分区">
		...
		<script type="text/javascript">
			...
			$("#no").click(function aaa(){
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/getrukuguanli3",
		             data: {"idss":idss.toString(),"q":"no","place_id":place_id,"time":new Date()},
			...
			$("#yes").click(function(){
				...
				$.ajax({
					 type: "GET",
		             url: "<%=basePath%>"+"StoreManageAction/getrukuguanli3",
		             data: {"idss":idss.toString(),"q":"yes","place_id":place_id,"time":new Date()},
		             success: function(data){
			             	alert(data);
							jQuery(grid_selector).trigger('reloadGrid');
		           		 }
			...
			//按钮链接
			var ajaxurl = "<%=basePath%>"+"StoreManageAction";
			var ajaxurlo = "<%=basePath%>"+"StoreManageAction";
			//
			var pageurl ="<%=basePath%>"+"StoreManageAction/getrukuguanli";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/saverukuguanli";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['申请单号', '状态','申请人','申请时间','涉及仓库'];
			var pagecolmodel =  [
			...
			var getPlaceUrl =  "<%=basePath%>"+"StoreManageAction/queryPlace";
		...
		<script src="<%=basePath%>assets/js/jqGrid/rukuguanlijqGridTwoJS.js"></script>
</body>
</html>
