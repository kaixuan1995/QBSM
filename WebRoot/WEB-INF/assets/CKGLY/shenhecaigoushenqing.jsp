...
<html lang="en">
	<head>
		...
		<title>审核采购申请——BlueDot物资管理系统</title>
	...
	<body>
		...
		<script type="text/javascript">
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/getshenhecaigoushenqing3",
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getshenhecaigoushenqing";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/saveshenhecaigoushenqing";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['申请单号', '类型','申请人','申请时间','是否加急'];
			var pagecolmodel =  [
