...
<html lang="en">
	<head>
		...
		<title>审核仓库物资调度申请——BlueDot物资管理系统</title>
	...
	<body>
		...
		<script type="text/javascript">
			$("#no").click(function aaa(){
				...
				$.ajax({
					 type:"GET",
		             url: "<%=basePath%>"+"StoreManageAction/getshenhecangkuwuzidiaodu2",
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getshenhecangkuwuzidiaodu";
			var tablename = "申请列表";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/saveshenhecangkuwuzidiaodu";
			//navButtons
			var editbtn=false;
			var addbtn=false;
			var delbtn=false;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['申请单号','申请仓库','申请时间','是否加急'];
			var pagecolmodel =  [
