					...
					<div class="col-xs-12">
						...
						<div id="main">
							<div class="space-24"></div>
								...
								<hr></hr>
								<div class="space-24"></div>
<form action="<%=basePath%>MenberInforAction/surexiugaimima"
	 method="post" class="form-horizontal" role="form">
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 原密码：</label>

		<div class="col-sm-9">
			<input type="password" id="form-field-1"  placeholder="原密码"
			 name="oldpassword" class="col-xs-10 col-sm-5" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="password" id="form-field-3" name="newpassword"
			  placeholder="新密码" class="col-xs-10 col-sm-5"/>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="password" id="form-field-2" name="surenewpassword"
			 placeholder="确认密码" class="col-xs-10 col-sm-5" />
			<span class="help-inline col-xs-12 col-sm-7">
			</span>
		</div>
	</div>
