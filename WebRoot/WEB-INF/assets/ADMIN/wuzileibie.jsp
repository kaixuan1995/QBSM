...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>物资类别——BlueDot物资管理系统</title>
	...
	<body>
		...
		<script type="text/javascript">
			...
			var pageurl ="<%=basePath%>"+"StoreManageAction/getwuzileibie";
			var tablename = "物资类别";
			var pageediturl ="<%=basePath%>"+"StoreManageAction/savewuzileibie";
			//navButtons
			var editbtn=true;
			var addbtn=true;
			var delbtn=true;
			...
			var refreshbtn=true;
			var viewbtn=true;
			var pagecolnames = ['类型编号', '类型名称','类型描述'];//,'最低库存','最高库存'
			var pagecolmodel =  [
