...
<html lang="en">
	<head>
		...
		<title>仓库管理——BlueDot物资管理系统</title>
	...
	<body>
		...
		<script type="text/javascript">
			...
			var pageurlo ="<%=basePath%>"+"SystemManageAction/getcangkuguanliPlace";
			var tablenameo = "仓库分区";
			var pageediturlo ="<%=basePath%>"+"SystemManageAction/savecangkuguanliPlace";
			//navButtons
			var editobtn=true;
			var addobtn=true;
			var delobtn=true;
			...
			var viewobtn=true;
			var pagecolnameso = ['仓库分区编号','仓库编号', '仓库分区名称'];
			var pagecolmodelo =  [
